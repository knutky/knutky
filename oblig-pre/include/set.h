 ...
 * a or b.
 */
set_t *set_union(set_t *a, set_t *b);   //check
 ...
 * in both a and b.
 */
set_t *set_intersection(set_t *a, set_t *b);   //check
 ...
 * in a and not in b.
 */
set_t *set_difference(set_t *a, set_t *b);   //check

/*
 * Returns a copy of the given set.
 */
set_t *set_copy(set_t *set);   //check
